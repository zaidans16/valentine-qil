const CONFIG = {
    ...
    flowerTitle: "Ini nanti bakalan jadi kado spesial buat kamu ",
    takeBouquetButton: "Terima hadiahnya ",
    bouquetMessage: "Yeay! Sekarang Udah Resmi jadi milik kamu 💕",
    nextFlowerButton: "Next ",
    collageTitle: "My Beautiful You",
    collageSubtitle: "INII DIAA FOTO FOTOO MOOD BOSTERR GUAAA AHHAHAHAH CIMOL BOJOT💕",
    nextCollageButton: "Satu halaman lagi… ",
    finalTitle: "Happy Valentine, My Love 💞",
    finalMessage: "Makasih ya udah hadir didunia aku dan bikin hari aku selalu terasa happy karena kamu. Semoga kamu tetep sabar dan sayang sama aku ya. Tungguin kado dari aku yaa hehe. Dan inget aku bakalan selalu ada buat kamu. Btw maaf ya telat hehehehe💕. Happy Valentine Cimol Bojotku 💕",
